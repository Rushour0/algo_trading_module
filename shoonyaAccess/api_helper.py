...
from allTypes.shoonya import TransactionType, ProductType, ExchangeType, OrderType, RetentionType
...
class Order:
    def __init__(
        self,
        buy_or_sell: TransactionType,
        product_type: ProductType,
        tradingsymbol: str,
        price_type: OrderType = None,
        quantity: int = None,
        price: float = None,
        trigger_price: float = None,
        discloseqty: int = 0,
        retention: RetentionType = RetentionType.DAY,
        remarks: str = "tag",
        order_id: str = None,
